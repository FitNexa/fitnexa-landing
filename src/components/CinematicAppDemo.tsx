...
export const CinematicAppDemo = () => {
    const [step, setStep] = useState(0);

    // Animation sequence timer
    useEffect(() => {
        const sequence = [
            { time: 0, step: 0 }, // Walk in (Lock screen)
            { time: 3000, step: 1 }, // Notification appears
            { time: 5000, step: 2 }, // Unlock / Splash
            { time: 6500, step: 3 }, // Dashboard / QR
            { time: 10000, step: 0 }  // Reset loop
        ];
    ...
    return (
        <div className="relative w-full h-[600px] bg-slate-900 overflow-hidden rounded-[40px] border border-white/10 shadow-2xl group">
            ...
            <motion.div
                ...
                style={{
                    backgroundImage: 'url(/cinematic_gym_background.png)', // Will fallback to gradient if missing
                }}
                animate={{
                    scale: [1, 1.1, 1.15, 1],
                    ...
                    <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div className="mt-8 flex flex-col items-center gap-4 w-full px-4">
                                    <div className="w-full bg-white/10 backdrop-blur-md rounded-2xl p-4 flex items-center gap-3 border border-white/10">
                                        ...
                                        <div>
                                            <div className="text-xs font-bold">FitNexa Gym</div>
                        ...
                        {step === 1 && (
                            <motion.div
                                ...
                                className="w-full h-full bg-slate-900/40 backdrop-blur-sm flex flex-col items-center pt-20 text-white"
                            >
                                {/* Same lockscreen but with active notification pulse */}
                                <div className="text-6xl font-thin tracking-tighter mb-2">09:41</div>
                                <div className="text-sm font-medium opacity-80">Wednesday, October 24</div>
                                ...
                                >
                                    <div className="w-full bg-white/20 backdrop-blur-xl rounded-2xl p-4 flex items-center gap-3 border border-blue-500/50 shadow-[0_0_30px_rgba(59,130,246,0.3)]">
                                        <div className="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center">
                        ...
                        {step === 2 && (
                            <motion.div
                                ...
                                exit={{ opacity: 0 }}
                                className="w-full h-full bg-blue-600 flex flex-col items-center justify-center text-white"
                            >
                                <motion.div
                            ...
                            >
                                ...
                                <div className="p-6 flex-1 flex flex-col gap-6">
                                    <div className="bg-slate-900 rounded-3xl p-6 text-white shadow-xl flex flex-col items-center text-center relative overflow-hidden">
                                        <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-blue-900 opacity-20" />

                                        <div className="text-xs font-bold uppercase tracking-widest text-blue-400 mb-4">Member Access</div>
